...
import {
  ...
  ProjectPlanningEdit,
} from "./pages/projectPlanning/ProjectPlanning";
// Locations
import {
  LocationCreate,
  LocationIndex,
...
} from "./pages/resourceAssignment/ResourceAssignment";
          ...
          <div className="flex">
            ...
            <div className="flex-1">
              <Routes>
                ...
                <Route
                  path="/projectPlannings"
                  element={<ProjectPlanningIndex />}
                />
                <Route
                  path="/projectPlannings/create"
                  element={<ProjectPlanningCreate />}
                />
                <Route
                  path="/projectPlannings/edit/:id"
                  element={<ProjectPlanningEdit />}
                />
                ...
                <Route
                  ...
                  element={<ResourceAssignmentIndex />}
                />
                <Route
                  path="/resourceAssignments/create"
                  element={<ResourceAssignmentCreate />}
                />
              </Routes>
            </div>
          </div>
