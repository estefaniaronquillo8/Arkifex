        ...
        {currentStep === 1 ? (
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <button
                type="submit"
                className="bg-green-500 hover:bg-green-300 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-4"
                onClick={() => setCurrentStep(2)} // Avanzar al siguiente paso
              >
                Siguiente
              </button>
            </div>
          ...
          >
            ...
            <button type="submit" className="btn-custom btn-primary">
              ...
              <button
                type="submit"
                className="bg-blue-500 hover:bg-gray-200 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-4"
              >
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <button
                type="button"
                className="bg-white hover:bg-slate-500 text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-4"
                onClick={() => setCurrentStep(1)} // Retroceder al paso anterior
              >
                Anterior
              </button>
            </div>
